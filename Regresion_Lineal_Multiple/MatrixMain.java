...
public class MatrixMain extends Agent {
    ...
    private class MyGenericBehaviour extends Behaviour {
            ...
            if (mensaje!= null) {
                ...
                if(msg.equals("a")){
                  ...
                  return;
                    ...
                    MLRM mrlm = new MLRM(MatrixY, MatrixX, a, b);
        
                    mrlm.main();
                    // fin = true;
                }
                } else{
                    System.out.println("Receptor MATRIX: Esperando a recibir mensaje...");
                    block();
                }
        ...
        public int onEnd() {
            System.out.println("Remove Matrix Agent");
            myAgent.doDelete();
            return super.onEnd();
        } 
    }
