...
public class Algebra {
    ...
    public double[][] matNuevaCon1(double MatrixX[][]){

        int MatrixXLengthRows = MatrixX.length;
        int MatrixXLengthColumns = MatrixX[0].length+1;
    
        //Crear Matrix Nueva.
        double [][]MatrixX1 = new double[MatrixXLengthRows][MatrixXLengthColumns];
    ...
    public double[][] matrixDatosFaltates(double MatrixX1[][], double MatrixX [][]){
